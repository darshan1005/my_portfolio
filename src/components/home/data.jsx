...
function data() {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Darshan
              <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
              ...
              <h3 className='home__subtitle'>Web Designer & Developer</h3>
              <p className='home__description'>I'm a complete web Designer & web Developer. Expertized at Figma, webFlow & Adobe. I'm very passionate & dedicated to my work.</p>
